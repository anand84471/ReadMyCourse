...
namespace StudentDashboard.API
{
    ...
    [JwtAuthenticationPass]
    [RoutePrefix("api/v1/account/student")]
     public class StudentApiAccountController : ApiController
    {
        HomeService objHomeService = new HomeService();
        StudentApiAccountService _service = new StudentApiAccountService();
        StringBuilder m_strLogMessage = new StringBuilder();
        StudentUserProvider objStudentUserProvider = new StudentUserProvider();
        StudentAccountService _accountService = new StudentAccountService();
        [AllowAnonymous]
        ...
        public async Task<SearchCourseHttpResponse> SearchCourse([FromBody] SerchCourseRequest objSerchCourseRequest)
        {
            ...
            try
            {
                ...
                {
                    objResponse.lsCourseDetailsModel = await _service.SearchForCourse(objSerchCourseRequest.m_strKey, 10, objSerchCourseRequest.m_iNoOfRowsFetched,
        ...
        public async Task<APIDefaultResponse> AddCourseQuestionByStudent([FromBody] StudentCourseQuestionModal objRequest)
        {
            ...
            try
            {
                ...
                if (StudentIdInRequest != -1 && objRequest != null)
                {
                    ...
                    if (await _service.AddQuestionAskForCourse(objRequest))
                    {
                        objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                        objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
                    }
        ...
        public async Task<AllQuestionAskedByStudentForCourse> FetchQuestionAsked(long CourseId)
        {
            ...
            try
            {
                ...
                {
                    objResponse.m_lsStudentCourseQuestionModal = await _service.GetAllQuestionOfStudentCourse(StudentIdInRequest, CourseId);
                    if (objResponse != null)
                    {
                        objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                        objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
        ...
        public async Task<SearchCourseHttpResponse> SearchCourseForStudent([FromBody] SerchCourseRequest objSerchCourseRequest)
        {
            ...
            try
            {
                ...
                if (objSerchCourseRequest != null)
                {
                    ...
                    objResponse.lsCourseDetailsModel = await _service.SearchForCourseForStudent(objSerchCourseRequest.m_strKey, 10, objSerchCourseRequest.m_iNoOfRowsFetched,
        ...
        public async Task<APIDefaultResponse> JoinCourse(StudentCourseJoinRequest studentCourseJoinRequest)
        {
            ...
            try
            {
                ...
                if (await _service.JoinStudentToCourse(studentCourseJoinRequest))
                {
                    objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                    objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
                }
        ...
        public async Task<APIDefaultResponse> JoinInstructor(int InstructorId)
        {
            ...
            try
            {
                if (await _service.JoinStudentToInstructor(StudentId, InstructorId))
                {
                    objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                    objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
                }
        ...
        public async Task<APIDefaultResponse> MarkTopicFinished(long TopicId)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.InsertReadTopicByStudent(StudentId, TopicId))
                {
                    objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                    objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
                }
        ...
        public async Task<StudentJoinedCoursesResponse> GetJoinedCourses([FromBody] GetJoinedCourseRequest objGetJoinedCourseRequest)
        {
            ...
            try
            {
                ...
                objResponse.lsStudentJoinedCoursesResponseModal = await _service.SerachForJoinedCourses(
        ...
        public async Task<SearchInstructorResponse> InstructorSearch([FromBody] GetJoinedCourseRequest objGetJoinedCourseRequest)
        {
            ...
            {
                objGetJoinedCourseRequest.m_llStudentGid = StudentId;
                objResponse.lsSearchInstructorResponseModal = await _service.SearchForInstructor(
        ...
        public async Task<SearchInstructorResponse> GetJoinedInstructors([FromBody] GetJoinedCourseRequest objGetJoinedCourseRequest)
        {
            ...
            {
                objGetJoinedCourseRequest.m_llStudentGid = StudentId;
                objResponse.lsSearchInstructorResponseModal = await _service.SearchForJoinedInstructor(objGetJoinedCourseRequest.m_llStudentGid,
                   objGetJoinedCourseRequest.m_strSearchString, Constants.MAX_ITEMS_TO_BE_RETURNED);
                if (objResponse.lsSearchInstructorResponseModal != null)
                {
                    objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
        ...
        public async Task<SearchForAssignmentsApiResponse> SearchForAssignments([FromBody] GetJoinedCourseRequest objGetJoinedCourseRequest)
        {
            ...
            try
            {
                objResponse.m_lsAssignments = await _service.SearchForAssignment(objGetJoinedCourseRequest.m_strSearchString, Constants.MAX_ITEMS_TO_BE_RETURNED, objGetJoinedCourseRequest.m_llLastFetchedId);
        ...
        public async Task<SearchForTestResponse> SearchTest([FromBody] GetJoinedCourseRequest objGetJoinedCourseRequest)
        {
            ...
            try
            {
                objResponse.m_lsTestDetailsModel = await _service.SearchForTest(objGetJoinedCourseRequest.m_strSearchString, 10, objGetJoinedCourseRequest.m_llLastFetchedId);
        ...
        public async Task<AssignmentSubmissionOfStudnetResponse> GetAllAssignmentSubmissionForStudent()
        {
            ...
            try
            {
                objResponse.m_lsOfStudentResponse = await _service.GetAllAssignmentSubmissions(StudentId);
        ...
        public async Task<TestSubmissionOfStudentResponse> GetAllTestSubmissionForStudent()
        {
            ...
            try
            {
                objResponse.m_lsTestSubmissionModal = await _service.GetAllTestSubmissions(StudentId);
        ...
        public async Task<SubmitAssignmentResponse> InsertAssignmentResponse([FromBody] AssignmentSubmissionRequest objAssignmentSubmissionRequest)
        {
            ...
            try
            {
                ...
                if (await _service.InserAssignmentResponse(objAssignmentSubmissionRequest))
                {
        ...
        public SubmitAssignmentResponse InsertTestResponse([FromBody] TestSubmissionRequest objInsertTestResponse)
        {
            ...
            try
            {
                ...
                if (_service.InsertTestResponse(objInsertTestResponse))
                {
        ...
        public async Task<GetAssignmentSubssionDetials> GetAssignmentSubmissionDetails(long id)
        {
            ...
            try
            {
                objResponse = await _service.GetAssignmentResponse(id, StudentId);
                if (objResponse != null)
                {
                    objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                    objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
        ...
        public async Task<GetTestSubmissionDetailsResponse> GetTestSubmissionDetails(long id)
        {
            ...
            try
            {
                objResponse = await _service.GetTestResponse(id, StudentId);
                if (objResponse != null)
                {
                    objResponse.m_iResponseCode = Constants.API_RESPONSE_CODE_SUCCESS;
                    objResponse.m_strResponseMessage = Constants.API_RESPONSE_MESSAGE_SUCCESS;
        ...
        public async Task<ClassroomDetailsResponse> GetClassroomDetails(long id)
        {
            ...
            try
            {
                ...
                if (StudentidInRequest != -1)
                {
                    objResponse.m_objClassRoomModal = await _service.GetClassroomDetailsForStudent(id);
                    if (objResponse != null)
                    {
        ...
        public async Task<APIDefaultResponse> JoinClassroom(StudentClassroomJoinRequest request)
        {
            ...
            try
            {
                ...
                if (StudentidInRequest != -1)
                {
                    ...
                    if (await _service.JoinClassroom(request))
                    {
                        objResponse.SetSuccessResponse();
                    }
        ...
        public async Task<APIDefaultResponse> MarkClassroomPaySuccess(StudentClassroomJoinRequest request)
        {
            ...
            try
            {
                ...
                {
                    request.m_llStudentId = StudentidInRequest;
                    if (await _service.MarkClassroomPaySuccess(request))
                    {
                        objResponse.SetSuccessResponse();
                    }
        ...
        public async Task<APIDefaultResponse> JoinClassroomTrial(long ClassroomId)
        {
            ...
            try
            {
                ...
                if (StudentidInRequest != -1)
                {
                    if (await _service.JoinClassroomTrial(StudentidInRequest, ClassroomId))
                    {
                        objResponse.SetSuccessResponse();
                    }
        ...
        public async Task<StudentClassroomResponse> GetJoinedClassrooms()
        {
            ...
            try
            {
                ...
                if (StudentidInRequest != -1)
                {
                    objResponse.m_lsStudentClassroomModal = await _service.GetJoinedClassroom(StudentidInRequest);
                    if (objResponse != null)
                    {
                        objResponse.SetSuccessResponse();
                    }
        ...
        public async Task<StudentClassroomResponse> JoinClassroomMeeting(long MeetingId)
        {
            ...
            try
            {
                ...
                if (StudentidInRequest != -1)
                {
                    ...
                    if (await _service.JoinClassroomMeeting(MeetingId, StudentidInRequest))
                    {
                        objResponse.SetSuccessResponse();
                    }
                }
        ...
        public async Task<StudentClassroomResponse> InsertNewMessageToClassroom(InsertStudentMessageToClassroom insertStudentMessageToClassroom)
        {
            ...
            {
                long StudentidInRequest = GetStudentIdInRequest();
                if (StudentidInRequest != -1 && await _service.CheckStudentAccessToClassroom(StudentidInRequest, insertStudentMessageToClassroom.m_llClassroomId))
                {
                    insertStudentMessageToClassroom.m_llStudentId = StudentidInRequest;
                    if (await _service.InsertNewMessageToClassroomByStudent(insertStudentMessageToClassroom))
                    {
                        objResponse.SetSuccessResponse();
                    }
                }
        ...
        public async Task<GetClassroomAllMessageResponseForStudent> GetAllClassroomMessage(long ClassroomId)
        {
            ...
            {
                long StudentidInRequest = GetStudentIdInRequest();
                if (StudentidInRequest != -1 && await _service.CheckStudentAccessToClassroom(StudentidInRequest, ClassroomId))
                {
                    objResponse.m_lsGetClassroomAllMessageResponseForStudent =
                        await _service.GetAllClassroomMessageForStudent(ClassroomId, StudentidInRequest
                        );
            ...
            try
            {
                ...
                if (StudentidInRequest != -1 && await _service.CheckStudentAccessToClassroom(StudentidInRequest, ClassroomId))
                {
                    objResponse.m_lsStudentClassroomAssignmentModal =
                        await _service.GetAllClassroomAssignment(ClassroomId, StudentidInRequest
                        );
        ...
        public async Task<GetAllStudentClassroomAssignment> GetAllClassroomSubmittedAssignment(long ClassroomId)
        {
            ...
            try
            {
                ...
                {
                    objResponse.m_lsStudentClassroomAssignmentModal =
                        await _service.GetAllClassroomSubmittedAssignment(ClassroomId, StudentidInRequest
                        );
                    if (objResponse.m_lsStudentClassroomAssignmentModal != null)
                    {
                        objResponse.SetSuccessResponse();
            ...
            try
            {
                ...
                if (StudentidInRequest != -1 && await _service.CheckStudentAccessToClassroom(StudentidInRequest, ClassroomId))
                {
                    objResponse.m_lsStudentClassroomTestModal =
                        await _service.GetAllClassroomTest(ClassroomId, StudentidInRequest
                        );
        ...
        public async Task<GetAllStudentClassroomtTest> GetAllClassroomTestSubmissions(long ClassroomId)
        {
            ...
            try
            {
                ...
                {
                    objResponse.m_lsStudentClassroomTestModal =
                        await _service.GetAllClassroomTestSubmissons(ClassroomId, StudentidInRequest
                        );
                    if (objResponse.m_lsStudentClassroomTestModal != null)
                    {
                        objResponse.SetSuccessResponse();
        ...
        public async Task<GetClassroomAllMessageResponseForStudent> GetAllClassroomMessageAfterLastMessage(long ClassroomId, long LastMessageId)
        {
            ...
            {
                long StudentId = GetStudentIdInRequest();
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, ClassroomId))
                {
                    objResponse.m_lsGetClassroomAllMessageResponseForStudent = await _service.GetAllClassroomLastMessagesForStudentAfterLast(ClassroomId, LastMessageId, StudentId);
                    if (objResponse.m_lsGetClassroomAllMessageResponseForStudent != null)
                    {
                        objResponse.SetSuccessResponse();
                    }
        ...
        public async Task<SearchStudentPublicClassroomResponse> GetPublicClassroom(MasterSearchRequestModel masterSearchRequestModel)
        {
            ...
            try
            {
                ...
                if (StudentId != -1)
                {
                    objResponse.m_lsGetPublicClassroomsResponse = await _service.SearchClassroom(masterSearchRequestModel.m_iNoOfRecordsFeteched,
        ...
        public async Task<ClassroomAcceptPaymentResponse> CreatePaymentRequestForClassroomJoin(ClassroomPaymentRequestDTO classroomPaymentRequestDTO)
        {
            ...
            try
            {
                ...
                if (classroomPaymentRequestDTO != null && StudentId != -1)
                {
                    ...
                    objResponse.razorPayPaymentRequestModal = await _service.GetClassroomPaymentData(classroomPaymentRequestDTO);
        ...
        public async Task<CourseAcceptPaymentResponse> CreatePaymentRequestForCourse([FromBody] ClassroomPaymentRequestDTO classroomPaymentRequestDTO)
        {
            ...
            try
            {
                ...
                if (StudentId != -1)
                {
                    ...
                    objResponse.razorPayPaymentRequestModal = await _service.GetCoursePaymentData(classroomPaymentRequestDTO);
                    if (objResponse.razorPayPaymentRequestModal != null)
                    {
                        objResponse.m_bIsJoined = objResponse.razorPayPaymentRequestModal.m_bIsJoined;
                        objResponse.m_bIsFreeCourse = objResponse.razorPayPaymentRequestModal.m_bIsFreeCourse;
        ...
        public async Task<GetTestResultsForStudentResponse> GetTestsForStudent(StudentTestSearchRequest studentTestSearchRequest)
        {
            ...
            try
            {
                ...
                if (StudentId != -1 && studentTestSearchRequest != null)
                {
                    ...
                    objResponse.m_lsStudentTestSearchResultModal = await _service.GetFreeTestsForStudent(studentTestSearchRequest);
        ...
        public async Task<SearchInstructorResponse> InstructorSearchNew([FromBody] GetJoinedCourseRequest objGetJoinedCourseRequest)
        {
            ...
            {
                objGetJoinedCourseRequest.m_llStudentGid = StudentId;
                objResponse.lsSearchInstructorResponseModal = await _service.SearchForInstructorNew(
        ...
        public async Task<GetAllStudentsToJoinRespone> FetchStudentsToJoin([FromBody] GetStudentsToFollowRequest objGetStudentsToFollowRequest)
        {
            ...
            try
            {
                if (StudentId != -1 && objGetStudentsToFollowRequest != null)
                {
                    ...
                    objResponse.m_lsStudentDetailToFolllow = await _service.GetAllStudentsToJoin(objGetStudentsToFollowRequest);
                }
        ...
        public async Task<StudentPublicProfileResponse> FetchStudentPublicDetails(long id)
        {
            ...
            try
            {
                if (StudentId != -1)
                {
                    objResponse = await _service.GetStudentPublicProfileResponse(id);
                }
                if (objResponse != null)
                {
                    objResponse.SetSuccessResponse();
        ...
        public async Task<APIDefaultResponse> JoinToStudent(long id)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.JoinStudentToStudent(StudentId, id))
                {
                    objResponse.SetSuccessResponse();
                }
        ...
        public async Task<GetAllStudentsFollowedByStudentResponse> GetAllFollowdStudents(GetAllStudentFollowedByStudentRequest getAllStudentFollowedByStudentRequest)
        {
            ...
            try
            {
                if (StudentId != -1)
                {
                    ...
                    objResponse.m_lsStudentFollowedByStudentDetails = await _service.GetAllStudentsFollwoedByStudent(getAllStudentFollowedByStudentRequest);
                    if (objResponse != null)
                    {
                        objResponse.SetSuccessResponse();
                    }
        ...
        public async Task<StudentToStudentConnectionDetails> FetchStudentToStudentConnection(long id)
        {
            ...
            try
            {
                if (StudentId != -1)
                {
                    objResponse = await _service.FetchStudentToStudentConnectionDetails(StudentId, id);
                }
                if (objResponse != null)
                {
                    objResponse.SetSuccessResponse();
        ...
        public async Task<GetStudentSelfProfileDetailsResponse> FetchStudentSelfProfileDetails()
        {
            ...
            try
            {
                if (StudentId != -1)
                {
                    objResponse.m_objStudentProfileDetails = await _service.FetchStudentSelfDetails(StudentId);
                }
        ...
        public async Task<GetAllLiveClassMeetingDetailsForStudentResponse> FetchAllLiveClassMeetingDetailForStudent(long ClassroomId)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, ClassroomId))
                {
                    objResponse.lsStudentLiveClassMeetingDetails = await _service.GetAllLiveClassMeetingDetailsForStudnet(StudentId, ClassroomId);
                }
        ...
        public async Task<GetClassroomMeetingDetailsForStudentResponse> FetchLiveClassMeetingDetailForStudent(GetClassroomMeetingDetailsForStudentRequest getClassroomMeetingDetailsForStudentRequest)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, getClassroomMeetingDetailsForStudentRequest.m_llClassroomId))
                {
                    getClassroomMeetingDetailsForStudentRequest.m_llStudentId = StudentId;
                    objResponse.studentLiveClassMeetingDetails = await _service.GetLiveClassMeetingDetailsForStudnet(getClassroomMeetingDetailsForStudentRequest);
                }
        ...
        public async Task<GetClassroomSyllabusResponse> GetClassroomSyllabus(long ClassroomId)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, ClassroomId))
                {
                    objResponse.ClassroomSyllabusDetailsModal = await _service.GetClassroomSyllabus(ClassroomId);
                }
        ...
        public async Task<GetClassroomSheduleResponse> GetClassroomSchedule(long ClassroomId)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, ClassroomId))
                {
                    objResponse.classroomScheduleDetails = await _service.GetClassroomSchedule(ClassroomId);
                }
        ...
        public async Task<APIDefaultResponse> InsertClassroomFeedback(ClassroomFeedbackRequest classroomFeedbackRequest)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, classroomFeedbackRequest.m_llClassroomId))
                {
                    classroomFeedbackRequest.m_llStudentId = StudentId;
                    if (await _service.InsertClassroomFeedback(classroomFeedbackRequest))
                    {
                        objResponse.SetSuccessResponse();
                    }
                }
            ...
            GetAllStudentsJoinedToClassroomForStudent(StudentsJoinedToClassroomRequestForStudent studentsJoinedToClassroomRequestForStudent)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, studentsJoinedToClassroomRequestForStudent.m_llClassroomId))
                {
                    studentsJoinedToClassroomRequestForStudent.m_llStudentId = StudentId;
                    objResponse.m_lsStudentsJoinedToClassroomDetailsForStudent = await _service.GetStudentsJoinedToClassroom(studentsJoinedToClassroomRequestForStudent);
        ...
        public async Task<GetAllLiveClassMeetingDetailsForStudentResponse> FetchAllTrailClassMeetingDetailForStudent(long ClassroomId)
        {
            ...
            try
            {
                if (StudentId != -1 && await _service.CheckStudentAccessToClassroom(StudentId, ClassroomId))
                {
                    objResponse.lsStudentLiveClassMeetingDetails = await _service.GetAllTrialLiveClassMeetingDetailsForStudnet(StudentId, ClassroomId);
                }
                if (objResponse.lsStudentLiveClassMeetingDetails != null)
                {
                    objResponse.SetSuccessResponse();
        ...
        public async Task<MasterApiResponse<ReviewsDetails>> FetchAllClassroomReviews(long ClassroomId)
        {
            ...
            try
            {
                if (StudentId != -1)
                {
                    objResponse.data = await _service.GetClassroomReview(ClassroomId);
                }
        ...
        [Route("Logout")]
        [HttpPost]
        public async Task<APIDefaultResponse> Logout()
        {
            long StudentId = GetStudentIdInRequest();
            ...
            try
            {
                ...
                {
                    Token = HttpContext.Current.Request.Headers["Authorization"].Substring("Bearer ".Length)
                };
                if (StudentId != -1 && await _accountService.LogoutSessionAsync(session))
                {
        ...
        [HttpPost]
        public async Task<APIDefaultResponse> UpdateStudentBasicProfileDetails(StudentProfileUpdateRequest request)
        {
            long StudentId = GetStudentIdInRequest();
            APIDefaultResponse response = new APIDefaultResponse();
            try
            {
                ...
                if (StudentId != -1 && await _service.UpdateStudentBasicProfileDetailsAsync(request))
                {
                    response.SetSuccessResponse();
                }
            ...
            {
                m_strLogMessage.Append("\n ----------------------------Exception Stack Trace--------------------------------------");
                m_strLogMessage = m_strLogMessage.AppendFormat("[Method] : {0}  {1} ", "UpdateStudentBasicProfileDetails", Ex.ToString());
                m_strLogMessage.Append("Exception occured in method :" + Ex.TargetSite);
                MainLogger.Error(m_strLogMessage);
            }
            return response;
        ...
        [HttpPost]
        public async Task<APIDefaultResponse> UpdatePassword(StudentChangePasswordRequest request)
        {
            long StudentId = GetStudentIdInRequest();
            APIDefaultResponse response = new APIDefaultResponse();
            try
            {
                ...
                if (StudentId != -1 && await _service.ChangePasswordAsync(request))
                {
                    response.SetSuccessResponse();
                }
        ...
        [HttpPost]
        public async Task<APIDefaultResponse> ChangeProfilePicture(StudentProfileChangeRequest request)
        {
            long StudentId = GetStudentIdInRequest();
            APIDefaultResponse response = new APIDefaultResponse();
            try
