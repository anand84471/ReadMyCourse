...
using StudentDashboard.Models.Notification;
...
namespace StudentDashboard.DTO
{
    public class StudentAccountServiceRepo
    {
        ...
        public async Task<bool> UpdateStudentBasicProfileDetailsAsync(StudentProfileUpdateRequest request)
        {
            ...
            try
            {
                result = await objCPDataService.UpdateStudentBasicProfileDetailsAsync(
                    request.m_llStudentId,request.m_strFirstName,request.m_strLastName,request.m_strPersonalWebsite,
                    request.m_strLinkedInUrl,request.m_strInstagramUrl,request.m_strTwitterUrl);
            }
            catch (Exception Ex)
            {
                m_strLogMessage.Append("\n ----------------------------Exception Stack Trace--------------------------------------");
        ...
        public async Task<bool> ChangePasswordAsync(StudentChangePasswordRequest request)
        {
            ...
            try
            {
                result = await objCPDataService.UpdateLoggedInStudentPasswordAsync(request.StudentId,
